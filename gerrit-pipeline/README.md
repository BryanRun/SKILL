...
最新版本及历史版本下载：[gerrit-pipeline-v1.9.2.zip](https://t83dfrspj4.feishu.cn/wiki/Urrkw0A72if06ykzcmFcSdsrnag)

### 8.1 本地打包发版流程

完整发版流程只生成本地 zip 产物，不包含飞书 API 上传；飞书文档或文件上传由维护者手动完成。

对应飞书使用手册：https://t83dfrspj4.feishu.cn/wiki/Tzq1wRg5biiaCLkcx2gcgcb6nO1

发版前必须先清空本地 `release/` 目录，再生成新的版本包，确保目录中只保留当前版本产物：
