...
> **硬规则 · 项目级（最高优先级）**：
> - **Java 缩进必须 4 个空格，禁止 tab**（项目硬规范，2026-04-19 团队约定）
> - **C++ 缩进必须 4 个空格，禁止 tab**（项目硬规范，2026-04-19 团队约定）
...
| 规则 | 依据 | 级别 |
|---|---|---|
| **缩进必须 4 个空格，禁止 tab** | **项目硬规范（2026-04-19 团队约定）** | **P1** |
...
- commit message 格式（原因分析/解决方案/自测用例/影响范围/代码修改量） — **团队约定不纳入本评审**，不评审错别字或格式
